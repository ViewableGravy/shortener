...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <style>
        ...
        * {
        ...
        .form-container, .auth, .title {
            min-width: min(100%, var(--max-width));
        }

        .login, .register, .input, .submit-button {
            height: 56px;
        ...
        @media screen and (max-width: 500px) {
            ...
            .input, .submit-button, .form-container {
                width: 100%;
            }
